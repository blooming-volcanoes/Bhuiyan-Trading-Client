...
const PdDetailsAndDescription = ({ bgImage }) => {
    ...
    return (
        <div
            ...
            className='w-full lg:w-1/2 pt-5 pl-5 pr-5 bg-no-repeat bg-cover bg-center'>
            ...
            <div className='w-full flex gap-1'>
                <button className='flex w-1/2 items-center justify-center bg-gray-100 h-20 hover:bg-gray-200 border-slate-500'>
                    ...
                    <span className='text-lg lg:text-2xl  ml-1'>Category Page</span>
                </button>
                <button className='flex w-1/2 items-center justify-center bg-gray-100 h-20 hover:bg-gray-200 border-slate-500'>
                    <span className='text-lg lg:text-2xl mr-1'>Home Page</span>
