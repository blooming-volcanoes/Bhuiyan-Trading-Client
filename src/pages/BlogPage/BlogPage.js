                    ...
                    <div className="mx-5 flex h-full min-h-[300px] max-w-4xl items-center md:mx-auto">
                        <div className="mt-20">
                            <h1 className="text-4xl font-medium">
                                This is title where i am going to write the tile of a page. this is
                                title.
                            </h1>
                    ...
                    <div className="space-y-4   ">
                        <div className="mx-5 flex flex-col justify-end">
                            ...
                            <p className="col-auto text-justify font-semibold ">
                                ...
                                magni exercitationem aliquid et recusandae praesentium. Molestiae,
                                velit cupiditate dolore similique soluta ea provident eius dolor
                                voluptatem tenetur sapiente maiores, officiis fugiat nesciunt
                                nostrum laboriosam? Sit itaque nam illum, repellendus impedit
                                doloribus enim, ad repudiandae sunt, aliquam aperiam repellat
                                veritatis obcaecati. Autem ipsam eos perferendis labore porro
                                voluptates tempore eum nesciunt non illum minima laudantium facere
                                qui possimus, excepturi
                                <br />
                                <div className="my-6">
                                    <img
